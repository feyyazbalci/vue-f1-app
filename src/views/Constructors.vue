<template>
  <div v-if="!loading" class="takimlar">
    ...
    <div class="row justify-center">
        ...
        <q-card dark class="my-card shadow-20 col-12 col-md-5 q-my-md" 
            ...
            <q-card-section>
              ...
              <div class="row no-wrap items-center">
                <div class="bg-grey q-mr-sm q-pa-sm rounded-borders">
                  ...
                  <span class="text-caption text-dark q-mx-md">{{ constructor.position }}</span>
                </div>
                ...
                <div class="bg-grey q-mr-sm q-pa-sm rounded-borders">
                  ...
                  <span class="text-caption text-dark q-mx-md">{{ constructor.wins }} wins</span>
                </div>
              </div>
...
export default {
  ...
  methods: {
    getImgUrl(picture) {
       return new URL(`../assets/img/cars/2022/${picture}.png`, import.meta.url).href
    },
    getColor,
  }
}
